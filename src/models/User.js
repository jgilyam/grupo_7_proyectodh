...
const user = {
  ...
  /* findByPK:function (id){
    para obtener todos los usuarios por id
  } */

  /* findByEmail: function(email){
    para obtener todos los usuarios por email
  } */
  
  generarId: function(){ //genero id buscando el ultimo y si no encuentrar traer id 1
